...
public class RomanCalActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		year_rome_et = (EditText) findViewById(R.id.roman_year_editText);
		...
		year_std_et.setTypeface(font);
		
		day_rome_et = (EditText) findViewById(R.id.roman_day_editText);
		day_rome_et.setTypeface(font);
		day_std_et = (EditText) findViewById(R.id.std_day_editText);
		day_std_et.setTypeface(font);
		
		prefix_sp = (Spinner) findViewById(R.id.prefix_spinner);
		
//		String data[] = res.getStringArray(R.array.roman_prefix);
//		List<String> d = Arrays.asList(data);
//		MyArrayAdapter maa = new MyArrayAdapter(this, R.layout.my_spinner_style, d);
//		maa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
//		for (int i=0; i<data.length; i++)
//			maa.add(data[i]);
//		MyArrayAdapter maa = new MyArrayAdapter(this, R.layout.);
//		maa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
//		prefix_sp.setAdapter(maa);
		
//		prefix_sp.setTypeface(font);
		beacons_sp = (Spinner) findViewById(R.id.beacons_spinner);
//		beacons_sp.setTypeface(font);
		months_sp = (Spinner) findViewById(R.id.months_spinner);
//		months_sp.setTypeface(font);
		...
		month_std_tv.setTypeface(font);
		year_std_tv = (TextView) findViewById(R.id.std_year_textView);
		year_std_tv.setTypeface(font);
